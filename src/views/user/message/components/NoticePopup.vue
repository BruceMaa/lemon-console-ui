        ...
        <div class="info">
          <a-space>
            <span>
              ...
              <span>{{ currentNotice?.createdUsername }}</span>
            </span>
            ...
            <a-divider v-if="currentNotice?.modifiedAt" direction="vertical" />
            <span v-if="currentNotice?.modifiedAt">
              <icon-schedule class="icon" />
              <span>更新时间：</span>
              <span>{{ currentNotice?.modifiedAt }}</span>
            </span>
          </a-space>
        </div>
        <div style="flex: 1;">
