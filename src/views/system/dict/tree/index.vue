<template>
  <div class="container">
    <div class="search">
      ...
      <a-button v-permission="['system:dicts:create']" type="primary" @click="onAdd">
        ...
        >
          ...
          <template #extra="node">
            <a-trigger trigger="click" align-point animation-name="slide-dynamic-origin" auto-fit-transform-origin position="bl" scroll-to-close>
              <icon-more v-if="has.hasPermOr(['system:dicts:update', 'system:dicts:delete'])" class="action" />
              <template #content>
...
import { deleteDict, listDict } from '@/apis'
