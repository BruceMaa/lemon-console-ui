<template>
  ...
  >
    <template #toolbar-left>
      <a-button v-permission="['system:roles:updatePermission']" type="primary" :disabled="disabled" @click="save">
...
import type { RolePermissionResp } from '@/apis'
import type GiTable from '@/components/GiTable/index.vue'
import { Message } from '@arco-design/web-vue'
import { nextTick, ref, watch } from 'vue'
import { getRole, listRolePermissionTree, updateRolePermission } from '@/apis'
...
const fetchRole = async (id: string) => {
  try {
    loading.value = true
    disabled.value = !has.hasPermOr(['system:roles:updatePermission'])
    // 查询角色详情
