      ...
      <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" :xxl="24" flex="1" class="h-full overflow-hidden">
        ...
        >
          ...
          <template #toolbar-right>
            <a-button v-permission="['system:dictItems:create']" type="primary" @click="onAdd">
              <template #icon><icon-plus /></template>
              <template #default>新增</template>
            </a-button>
            <a-button v-permission="['system:dictItems:clearCache']" type="outline" status="warning" @click="onClearCache">
          ...
          <template #action="{ record }">
            <a-space>
              <a-link v-permission="['system:dictItems:update']" title="修改" @click="onUpdate(record)">修改</a-link>
              <a-link
                v-permission="['system:dictItems:delete']"
                status="danger"
                title="删除"
...
import { clearDictCache, deleteDictItem, listDictItem } from '@/apis'
...
const columns: TableInstance['columns'] = [
  ...
  { title: '创建人', dataIndex: 'createdUsername', width: 140, ellipsis: true, tooltip: true, show: false },
  { title: '创建时间', dataIndex: 'createdAt', width: 180 },
  { title: '修改人', dataIndex: 'modifiedUsername', width: 140, ellipsis: true, tooltip: true, show: false },
  { title: '修改时间', dataIndex: 'modifiedAt', width: 180, show: false },
  {
    ...
    show: has.hasPermOr(['system:dictItems:update', 'system:dictItems:delete']),
  },
]
