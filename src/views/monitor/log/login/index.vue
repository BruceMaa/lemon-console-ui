<template>
  ...
  >
    <template #toolbar-left>
      <a-input-search v-model="queryForm.createdUsername" placeholder="搜索登录用户" allow-clear @search="search" />
...
import type { LogQuery } from '@/apis'
...
const columns: TableInstance['columns'] = [
  ...
  { title: '用户昵称', dataIndex: 'createdUsername', ellipsis: true, tooltip: true },
