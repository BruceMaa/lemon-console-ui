  ...
  <a-row style="margin-top: 15px">
    <a-descriptions :column="1" layout="inline-vertical">
      ...
      <a-descriptions-item label="大小">
        <span v-if="data.type === 0" v-permission="['system:files:calcDirSize']">
          <a-link
      ...
      <a-descriptions-item label="上传时间">{{ data.createdAt }}</a-descriptions-item>
      <a-descriptions-item v-if="data?.modifiedAt" label="修改时间">{{ data?.modifiedAt }}</a-descriptions-item>
